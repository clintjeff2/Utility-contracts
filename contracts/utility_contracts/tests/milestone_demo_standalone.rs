...
impl MilestoneManager {
    ...
    pub fn add_milestone(
        ...
        self.milestones
            .insert((meter_id, milestone_number), milestone);
        Ok(())
    }
...
fn main() {
    ...
    manager
        .create_maintenance_fund(meter_id, total_budget, phases)
        .expect("Failed to create maintenance fund");

    println!(
        "   Fund created: ${:.2} for {} phases",
        total_budget as f64 / 100.0,
        phases
    );
    ...
    for (num, desc, amount) in &milestones {
        manager
            .add_milestone(meter_id, *num, desc.to_string(), *amount)
    ...
    test_manager
        .create_maintenance_fund(200u64, 3000i128, 3u32)
        .unwrap();
    test_manager
        .add_milestone(200u64, 1u32, "Phase 1".to_string(), 1000i128)
        .unwrap();
    test_manager
        .add_milestone(200u64, 2u32, "Phase 2".to_string(), 1000i128)
        .unwrap();
    test_manager
        .add_milestone(200u64, 3u32, "Phase 3".to_string(), 1000i128)
        .unwrap();
    ...
    test_manager
        .complete_milestone(200u64, 1u32, vec![1, 2, 3], "admin".to_string())
        .unwrap();
    ...
    test_manager2
        .create_maintenance_fund(300u64, 1000i128, 2u32)
        .unwrap();
    test_manager2
        .add_milestone(300u64, 1u32, "Phase 1".to_string(), 1500i128)
        .unwrap(); // Exceeds fund
    ...
    println!(
        "   Total allocated: ${:.2}",
        final_fund.total_allocated as f64 / 100.0
    );
    println!(
        "   Total released: ${:.2}",
    ...
    println!(
        ...
        final_fund.current_milestone == final_fund.total_milestones
    );
